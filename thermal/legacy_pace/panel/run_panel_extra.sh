...
echo "### 1. linearity check: 40 C inlet at the cited 70k ###"
run design_map_1p15_tin40 1 1.15 70000 40 14.1 35.9 57.7 1.44 ""
echo "### 2. design map at the archived 100k ###"
run design_map_1p15_h100k 1 1.15 100000 55 14.1 35.9 57.7 1.44 ""
echo "### 3. plane cuts at 70k, optics ON -- the field the figure should show ###"
run design_map_1p15_plane    1 1.15 70000 55 14.1 35.9 57.7 1.44 glass_map1p15_h70k
run design_map_1p15_plane_si 0 1.15 70000 55 14.1 35.9 57.7 1.44 si_map1p15_h70k

echo "=== DONE ==="
column -s, -t "$OUT" | head -20
echo
echo "=== linearity: outlet corner at Tin=55 was 135.143; at Tin=40 expect ~120 ==="
awk -F, '$2=="design_map_1p15_tin40" && $7==3 && $8==3 {print "  Tin=40 outlet corner:", $11}' "$OUT"
