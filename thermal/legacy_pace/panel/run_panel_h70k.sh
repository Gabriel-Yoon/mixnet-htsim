...
echo "### 70k baselines to isolate the PIC contribution ###"
run die_only_h70k 1 none 70000 0 0 0 0
run die_only_h70k_si 0 none 70000 0 0 0 0

echo "=== DONE ==="
column -s, -t "$OUT" | head -40
