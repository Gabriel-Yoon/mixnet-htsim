...
| `fig_thermal_transient` | `scripts/figures/plot_thermal_transient.py` → `fig_thermal_transient.png`: `experiments/results/thermal/tile_schedule.csv` (status final, glass; delta_pp_K vs period_s per p_lo_W) and `tile_transient.csv` glass_stack_h200k_long step asymptote; period sweep requested from the peer 2026-09-08 |
