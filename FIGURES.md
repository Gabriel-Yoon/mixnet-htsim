...
| `fig_panel_size` | `scripts/figures/plot_panel_size.py` → `fig_panel_size.png`: quotable rows of `panel_dse.csv`, iteration of the 8x8 flattened butterfly (128 GB/s optical links) and the 8x8 electrical mesh normalized to the 4x4 panel at EP 16/32/64; the 8x4 arm is not drawn (user decision 2026-09-09). In the DATE paper as Fig. 7 (Sec. V-C) since 2026-09-13. |
