...
for T0, name, y0, va in ((0.01084, "microbatch", 31.5, "top"), (0.08675, "iteration", 1.0, "bottom")):
...
ax.legend(frameon=False, fontsize=6.8, loc="center right", bbox_to_anchor=(1.0, 0.40), handlelength=2.0)
