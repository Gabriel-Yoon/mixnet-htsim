...
| `fig_phases` | `scripts/figures/plot_a2a_share.py` → `fig_phases.png`: expert_a2a_ms / makespan_ms from `decomp_critpath.csv` at the quotable `cliff_all.csv` rows (hgx8_pkt, nvl64_pkt_s1; mb 8) |
